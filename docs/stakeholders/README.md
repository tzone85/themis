...
All Themis documents (design spec + audience-specific briefs) live together under `docs/superpowers/specs/`. This index points to each one by audience.

## Read this first
- [**Executive summary**](../superpowers/specs/2026-05-22-themis-exec-summary.md) — one page; decide in one meeting.
